...
public class PacketFluidSlotUpdate implements ISelfHandleMessage<IMessage> {

	private short containerSlot;
	private FluidStack stack;

	public PacketFluidSlotUpdate() {}

	public PacketFluidSlotUpdate(short containerSlot, FluidStack stack) {
